...
export default function PatientProfile({ route, navigation }) {
    ...
    return (
        ...
        /* Displays patient-specific personal inforamation*/
        <View>
            ...
            {/* Modal containing patient visit form */}
                ...
                <Modal
                    ...
                    <View style={modalStyles.centeredView}>
                        <View style={modalStyles.modalView}>
                            ...
                            {/* Displays  patient's visit information */}
                            ...
                            {/* Button to close 'visit form' modal */}
                            <TouchableOpacity
